 ...
 */
export type SubjectTypeName = 'book' | 'anime' | 'music' | 'game' | 'real';

export const SubjectTypeName = {
    Book: 'book' as SubjectTypeName,
    Anime: 'anime' as SubjectTypeName,
    Music: 'music' as SubjectTypeName,
    Game: 'game' as SubjectTypeName,
    Real: 'real' as SubjectTypeName
}
