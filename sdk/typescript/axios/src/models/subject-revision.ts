...
import { SubjectRevisionAllOf } from './subject-revision-all-of';
import { SubjectRevisionData } from './subject-revision-data';

/**
 * @type SubjectRevision
 * @export
 */
export type SubjectRevision = Revision & SubjectRevisionAllOf;
