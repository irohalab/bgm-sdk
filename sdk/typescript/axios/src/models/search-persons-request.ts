...
// @ts-ignore
import type { SearchPersonsRequestFilter } from './search-persons-request-filter';
...
export interface SearchPersonsRequest {
     ...
     * 
     * @type {string}
     * @memberof SearchPersonsRequest
     */
    'keyword': string;
    /**
     * 
     * @type {SearchPersonsRequestFilter}
     * @memberof SearchPersonsRequest
     */
    'filter'?: SearchPersonsRequestFilter;
}
