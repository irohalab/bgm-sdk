...
import { SubjectSmallAllOfRating } from './subject-small-all-of-rating';

/**
 * 
 * @export
 * @interface SubjectSmallAllOf
 */
export interface SubjectSmallAllOf {
    /**
     * 话数
     * @type {number}
     * @memberof SubjectSmallAllOf
     */
    'eps'?: number;
    /**
     * 话数
