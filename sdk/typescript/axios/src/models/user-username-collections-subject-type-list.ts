 ...
 * 
 * @export
 * @interface UserUsernameCollectionsSubjectTypeList
 */
export interface UserUsernameCollectionsSubjectTypeList {
    /**
     * 条目 ID
     * @type {string}
     * @memberof UserUsernameCollectionsSubjectTypeList
     */
    'subject_id'?: string;
    /**
     * 
